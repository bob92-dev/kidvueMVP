...
<link href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
	...
	<div class="container">
		<div class="card">
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img v-bind:src='annonce.imageUrl' /></div>
						</div>
					</div>
            ...
            <p class="vote"><strong>Marque: {{annonce.marque}}</strong></p>
            <grand>Lieu: {{annonce.ville}} <i class="glyphicon glyphicon-map-marker"></i></grand><br>
