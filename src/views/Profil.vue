  ...
  <form class="center">
    ...
    <label
      ...
      <input
        v-model="adress"
        type="text"
        placeholder="Adresse complet: 1 rue de paris"
    /></label>

    <label
      >Code postal: <input v-model="codePostal" type="text" placeholder="75001"
    /></label>
    <input
      v-model="ville"
      class="input"
    ...
    /></label>
    <button @click.prevent="writeUserData" class="btn btn-secondary">
      Valider
    </button>
  </form>
</template>
